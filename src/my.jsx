            ...
            <div className="bg-white border-b border-gray-200 w-full">
                <div className="px-8">
                    <div className="flex space-x-8">
                        <button
                            className={`py-4 px-2 text-lg font-bold border-b-3 transition-all duration-200 ${activeTab === 'rm'
                        ...
                        <button
                            className={`py-4 px-2 text-lg font-bold border-b-3 transition-all duration-200 ${activeTab === 'rd'
                                ? 'border-blue-600 text-blue-600 bg-blue-50'
                                : 'border-transparent text-gray-600 hover:text-gray-800 hover:border-gray-300 hover:bg-gray-50'
                                }`}
                        ...
                        <button
                            className={`py-4 px-2 text-lg font-bold border-b-3 transition-all duration-200 ${activeTab === 'csm'
                                ? 'border-blue-600 text-blue-600 bg-blue-50'
                                : 'border-transparent text-gray-600 hover:text-gray-800 hover:border-gray-300 hover:bg-gray-50'
                                }`}
                                    ...
                                    return (
                                        <div key={idx} className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200 shadow-lg p-6 transform hover:scale-105 transition-all duration-200">
                                            ...
                                            <div className="flex items-center mb-4">
                                                <span className="text-2xl font-bold text-gray-900">{account.active+account.inactive}</span>
                                ...
                                <div className="grid grid-cols-6 gap-3 mb-4">
                                    ...
                                    <div className="col-span-2 bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-xl border border-green-200 text-center shadow-lg">
                                        <div className="text-2xl font-bold text-green-600 mb-1">
                                            {getFilteredAccountData().reduce((sum, account) => sum + account.active+account.inactive, 0)}
                                        </div>
                                        <div className="text-xs text-green-700 font-bold uppercase">Active Candidates</div>
                                        <div className="text-xs text-green-600 mt-1">
                                            {Math.round((getFilteredAccountData().reduce((sum, account) => sum + account.active + account.inactive, 0) /
